...
![Typical Vector Database Workflow](/images/RelevanceAI_vectorbase_workflow.png) 
...
![Experimentation-first Vector Database Workflow](/images/RelevanceAI_experimentation_first_example_flow.png) 
