...
![Get your Auth Details](/images/RelevanceAI_auth_token_details.png) 
...
Here we create the dataset and insert the data into it. Data is stored as JSON Documents in Relevance thus from the sdk we insert list of python dictionaries as data. For more information about this [Inserting data](/docs/python-inserting-data).
